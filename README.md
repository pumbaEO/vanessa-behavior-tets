...
* Необходимо иметь установленный oscript и доступность его вызова в перменной PATH 
* Установелнную 8.3.8 
...
* В коммандной строке необходимо запустить compile.bat/./compilet.sh] для возможности сборки исходников во внешние обработки. 
