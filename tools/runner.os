...
Процедура СледитьЗаИзменениямиEPF(Значение, КэшПутей, Фильтр = "")
    ...
    Для каждого Файл из СписокФайлов Цикл
        ...
        Если Изменен = Истина Тогда
            Если ТипФайлаПоддерживается(Файл) Тогда
                Лог.Информация("Разбираем внешнюю обработку "+Файл.Путь);
...
Процедура Следить(Знач ФайлНастроек = "", Знач Фильт = "")
    Перем КэшПутей;
