...
Функция ЗапускВКоманднойСтроке()
    ...
    Попытка
        ...
        ИначеЕсли Команда = ВозможныеКоманды().РазобратьНаИсходникиТекущуюКонфигурацию Тогда
            РазобратьНаИсходникиТекущуюКонфигурацию(Аргументы.ЗначенияПараметров["ПутьКИсходникам"], 
                            Аргументы.ЗначенияПараметров["--ibname"], Аргументы.ЗначенияПараметров["--db-user"], Аргументы.ЗначенияПараметров["--db-pwd"],
                            Аргументы.ЗначенияПараметров["--v8version"]);
        ИначеЕсли Команда = ВозможныеКоманды().РазобратьНаИсходники Тогда
            РазобратьФайлКонфигурации(Аргументы.ЗначенияПараметров["ПутьКCF"], Аргументы.ЗначенияПараметров["ПутьКИсходникам"], Аргументы.ЗначенияПараметров["--v8version"]);
        
    
        ИначеЕсли Команда = ВозможныеКоманды().Помощь Тогда
            ВывестиСправку();
        ИначеЕсли Команда = ВозможныеКоманды().СобратьИзИсходников Тогда
            СобратьФайлКонфигурации(Аргументы.ЗначенияПараметров["ПутьКИсходникам"], Аргументы.ЗначенияПараметров["ПутьКCF"], Аргументы.ЗначенияПараметров["--v8version"]);
        ИначеЕсли Команда = ВозможныеКоманды().СобратьИзИсходниковТекущуюКонфигурацию Тогда
            СобратьИзИсходниковТекущуюКонфигурацию(Аргументы.ЗначенияПараметров["ПутьКИсходникам"], 
        ...
        ИначеЕсли Команда = ВозможныеКоманды().РазобратьРасширение Тогда 
            РазобратьНаИсходникиРасшрение(Аргументы.ЗначенияПараметров["НаименованиеРасширения"], Аргументы.ЗначенияПараметров["ПутьКИсходникам"], 
                            Аргументы.ЗначенияПараметров["--ibname"], Аргументы.ЗначенияПараметров["--db-user"], Аргументы.ЗначенияПараметров["--db-pwd"],
                            Аргументы.ЗначенияПараметров["--v8version"]);
                            
        ИначеЕсли Команда = ВозможныеКоманды().СобратьРасширение Тогда 
            СобратьИзИсходниковРасшрение(Аргументы.ЗначенияПараметров["ПутьКИсходникам"], Аргументы.ЗначенияПараметров["НаименованиеРасширения"],
                            Аргументы.ЗначенияПараметров["--ibname"], Аргументы.ЗначенияПараметров["--db-user"], Аргументы.ЗначенияПараметров["--db-pwd"],
                            Аргументы.ЗначенияПараметров["--v8version"]);
