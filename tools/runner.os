                ...
                Для каждого Файл из СписокФайлов Цикл
                    ...
                    Если Изменен = Истина Тогда
                        ...
                        ИначеЕсли ОбработкуНашли = Истина Тогда 
                            ...
                            Сообщить(КаталогВыгрузкиОбработки); 
                            ...
                            ФайлСобранный = Новый Файл(ИмяФайлаОбъекта);
                ...
                Для каждого Файл из СписокФайлов Цикл
                    ...
                    Если Изменен = Истина Тогда
                        Если ТипФайлаПоддерживается(Файл) Тогда
                            ...
                            СписокФайловНовый = НайтиФайлы(КаталогРазобранный, ПолучитьМаскуВсеФайлы(), Истина);
                            Для каждого ФайлНовыйКэша Из СписокФайловНовый Цикл
                                Если ФайлНовыйКэша.ЭтоКаталог() Тогда
